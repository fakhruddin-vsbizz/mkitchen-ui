...
const NewPurchase = () => {
  ...
  const onAddIngredient = () => {
    var ingredient_added = {
      ingredient_name: document.getElementById("ingredient-item-selected")
        .value,
    };
            ...
            <List.Item>
              <Card>
                ...
                <Row>
                  <Col xs={12} xl={12}>
                    Search vendor:{" "}
                    <Input placeholder="Eg: VK General Store, Brahma Stores, etc"></Input>
                  </Col>
                  <Col xs={12} xl={12}>
                    Price per KG: <Input placeholder="Eg: 2,3,15, etc"></Input>
                  </Col>
                  <Col xs={12} xl={12}>
                    <br />
                    Quantity ordered:{" "}
                    <Input placeholder="Eg: 2,3,15, etc"></Input>
                  </Col>
                </Row>
              </Card>
            </List.Item>
